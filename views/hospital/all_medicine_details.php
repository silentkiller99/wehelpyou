            ...
            <div class="main-content">
                <div class="container-fluid">
                    <div class="page-title">
                        <h4>Show All Medicine details</h4>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-block">
                                    <div class="table-overflow">
                                        <a href="<?= base_url('addMedicine') ?>" class="btn btn-danger"
                                           style="float: right">Add Medicine</a>
                                        <table id="d_table" class="table table-lg table-hover">
                                            ...
                                            $where3 = "(hospital_id = $vid AND type = '1')";
                                                ...
                                                foreach ($data as $d) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="relative mrg-top-15">
                                                                <?php
                                                                $where = "(medicine_id = " . $d['id'] . " AND hospital_id = $vid)";
                                                                $get = getRowByMoreId('tbl_history', $where);
